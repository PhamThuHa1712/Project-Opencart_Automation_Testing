...
public class AddToCartSystemTest extends BaseClass {
	...
	@Test
	public void TC_ATC_008_AddToCart_CrossBrowserEnvironment() {
		logger.info("***** Bắt đầu TC_ATC_008_AddToCart_CrossBrowserEnvironment *****");
		...
		logger.info("***** Kết thúc TC_ATC_008_AddToCart_CrossBrowserEnvironment *****");
	}
}
